...
try {
  ...
  console.log("No cars.json found – car tools disabled");
}
...
app.post("/api/chat", requireApiKey, async (req, res) => {
  try {
    // Accept both formats (message or messages array)
...
- Explaining how to construct or build things step-by-step
